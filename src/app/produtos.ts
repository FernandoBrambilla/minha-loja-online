...
export const produtos: IProduto[]= [
    { id: 1, descricao: "Mouse Logitech M90 Usb Preto", preco: 65.00, descricaoPreco: "À vista no PIX", imagem: "./assets/mouse-logitech-m90-usb-preto.jpg", quantidadeEstoque:3},
